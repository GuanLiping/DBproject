...
public class ModifyCustomer extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out=response.getWriter();
		  ...
		  String sqlC="UPDATE Customer SET name='"+name+"',password='"+password+"',category='"+category+"',phone_number='"+phone_number+"',email='"+email+"' WHERE id ='"+id+"'";
		  String sql="select address_id from Customer where id='"+id+"'";	  
